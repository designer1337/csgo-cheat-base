...
void render::draw_filled_rect(std::int32_t x, std::int32_t y, std::int32_t w, std::int32_t h, color color) {
	interfaces::surface->set_drawing_color(color.r, color.g, color.b, color.a);
	interfaces::surface->draw_filled_rectangle(x, y, w, h);
}

void render::draw_outline(std::int32_t x, std::int32_t y, std::int32_t w, std::int32_t h, color color) {
	interfaces::surface->set_drawing_color(color.r, color.g, color.b, color.a);
	interfaces::surface->draw_outlined_rect(x, y, w, h);
}

void render::draw_textured_polygon(std::int32_t n, vertex_t* vertice, color color) {
...
void render::draw_circle(std::int32_t x, std::int32_t y, std::int32_t r, std::int32_t s, color color) {
